...
class RepConfig(BaseConfig):
    ...
    def __init__(self, device, global_random_seed):
        ...
        self.data_root = {
            ...
            'ubo2014original':  '/root/autodl-tmp/data/ubo2014/ubo2014_resampled_allrandom',
            ...
            'default':          '/root/autodl-tmp/data/ubo2014/ubo2014_resampled_allrandom',
        }
        ...
        self.checkpoint_path = '/root/autodl-tmp/decoder1209/epoch-30.pth'
