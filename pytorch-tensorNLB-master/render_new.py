...
import exr
from utils import wiwo_xyz_to_hd_thetaphi, thetaphi_to_xyz, xy_to_xyz, print
...
main_ckpt = torch.load('/root/autodl-tmp/decoder1209/epoch-30.pth')
...
root = "/root/autodl-tmp/torch/render"
