...
def createUBO2014BSDF(path, available_texels_u, available_texels_v, interp_type):
    bsdfProps = Properties('ubo2014_bsdfList_rainer20_randomdirection_uvloop')
...
if __name__ == '__main__':
    ...
    for material in materials:
        save_dir = f'/test/repositories/mitsuba-pytorch-tensorNLB/rainer20/abrdf-conversion/generated_data/{material}_{num_texels[0]}x{num_texels[1]}_{num_queries}'
        if not os.path.exists(save_dir):
            os.mkdir(save_dir)
