...
def createUBO2014BSDF(
    ...
    bsdfProps = Properties('ubo2014_bsdfList_randomdirection')
...
if __name__ == '__main__':
    ...
    available_texels_u = 40
    available_texels_v = 40
    interval_u = 10
    interval_v = 10
    ...
    data_path = f'/opt/data/private/ubo2014/ubo2014_resampled_randomdirection'
